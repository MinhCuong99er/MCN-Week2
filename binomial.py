...
print ("Kết quả của hàm sumProb(15, 0.15) là: ", sumProb(15, 0.15))
print ("Kết quả của hàm sumProb(300, 0.3) là: ", sumProb(300, 0.3))
...
print ("Kết quả của hàm approxEntropy(15, 0.5) là: ", approxEntropy(15, 0.5))
