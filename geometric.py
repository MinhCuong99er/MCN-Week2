...
print ("Kết quả của hàm sumProb(150, 0.15) là: ", sumProb(150, 0.15))
print ("Kết quả của hàm sumProb(1500, 0.15) là: ", sumProb(1500, 0.15))
...
print ("Kết quả của hàm approxEntropy(30, 0.5) là: ", approxEntropy(30, 0.5))
print ("Kết quả của hàm approxEntropy(500, 0.5) là: ", approxEntropy(500, 0.5))