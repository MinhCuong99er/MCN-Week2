...
print ("Kết quả của hàm sumProb(150, 0.15, 3) là: ", sumProb(150, 0.15, 3))
print ("Kết quả của hàm sumProb(300, 0.3, 3) là: ", sumProb(300, 0.3, 3))
...
print ("Kết quả của hàm approxEntropy(150, 0.5, 3) là: ", approxEntropy(150, 0.5, 3))
print ("Kết quả của hàm approxEntropy(500, 0.5, 5) là: ", approxEntropy(500, 0.5, 5))